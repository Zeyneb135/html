...
// //?id-e gore olkeni tapan funksiya yazin;
// function sss(country) {
//     let ccc = result.find(item => item.id === country);
//     console.log(ccc);
// }


//?olkeye gore obyekti tapan funksiya yazin;
// function findByCountry(countryName) {
//     let order = result.find(item => item.shipAddress.country === countryName);
//     console.log(order);
    
// }


//?ide gore shipname, country ve city tapan funksiya yazin;
// function findShipById(id) {
//     let order = result.find(item => item.id === id);
//     console.log({ shipName: order.shipName, country: order.shipAddress.country, city: order.shipAddress.city });
// }


//?ide gore nece novde satis edildiyini gosteren funksiya yazin(details sayi);
...
//?ide gore bir obyektin toplam qazancini tapanj function yazin(discount daxil);
// function TotalById(id) {
//     let order = result.find(item => item.id === id)
//         let totalRevenue = order.details.reduce((total, detail) => {
//             let revenue = detail.unitPrice * detail.quantity; 
//             let discountAmount = revenue * (detail.discount / 100); 
//             return total + (revenue - discountAmount);
//         }, 0);
        
//         console.log(`Total revenue for ID ${id}: ${totalRevenue.toFixed(2)}`);
